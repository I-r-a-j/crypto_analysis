...
st.write("Simple Moving Average (SMA):", analysis.moving_averages.get('SMA', 'N/A'))
st.write("Exponential Moving Average (EMA):", analysis.moving_averages.get('EMA', 'N/A'))
st.write("Relative Strength Index (RSI):", analysis.oscillators.get('RECOMMENDATION', 'N/A'))
st.write("Stochastic Oscillator (Stoch):", analysis.oscillators.get('STOCH', 'N/A'))
st.write("Moving Average Convergence Divergence (MACD):", analysis.oscillators.get('MACD', 'N/A'))
st.write("Average Directional Index (ADX):", analysis.indicators.get('ADX', 'N/A'))
st.write("Ichimoku Cloud (Ichimoku):", analysis.indicators.get('Ichimoku', 'N/A'))
st.write("Bollinger Bands (BB):", analysis.indicators.get('BB', 'N/A'))
st.write("On-Balance Volume (OBV):", analysis.indicators.get('OBV', 'N/A'))
st.write("Fibonacci Retracement Levels:", analysis.indicators.get('Fib Retracement', 'N/A'))
