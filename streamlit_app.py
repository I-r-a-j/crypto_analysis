...
st.write("Moving Averages (MA):", analysis.moving_averages['RECOMMENDATION'])
st.write("Simple Moving Average (SMA):", analysis.moving_averages['SMA'])
st.write("Exponential Moving Average (EMA):", analysis.moving_averages['EMA'])
st.write("Relative Strength Index (RSI):", analysis.oscillators['RECOMMENDATION'])
st.write("Stochastic Oscillator (Stoch):", analysis.oscillators['STOCH'])
st.write("Moving Average Convergence Divergence (MACD):", analysis.oscillators['MACD'])
st.write("Average Directional Index (ADX):", analysis.indicators['ADX'])
st.write("Ichimoku Cloud (Ichimoku):", analysis.indicators['Ichimoku'])
st.write("Bollinger Bands (BB):", analysis.indicators['BB'])
st.write("On-Balance Volume (OBV):", analysis.indicators['OBV'])
st.write("Fibonacci Retracement Levels:", analysis.indicators['Fib Retracement'])
